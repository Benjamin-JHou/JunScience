...
export const FigureGeneratorTool: ToolDefinition<FigureGeneratorInput> = {
  ...
  async execute(input: FigureGeneratorInput, context: ToolContext): Promise<ToolExecutionResult> {
    ...
    const volcanoArtifact = mockDefaultArtifacts.find((a) => a.type === 'figure') || {
      id: `art-fig-${Date.now()}`,
    ...
    return {
      ...
      execution: {
        ...
        logs: [
          ...
          `Artifact saved: volcano_plot_sle_targets.svg`,
        ],
      },
    };
  },
