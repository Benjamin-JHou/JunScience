import { ModelProfile, ProtocolType } from '../types/model.js';
...
export function validateProfile(profile: Partial<ModelProfile>): { valid: boolean; errors: string[] } {
  const errors: string[] = [];
...
export function createDefaultProfile(override?: Partial<ModelProfile>): ModelProfile {
  return {
