export class ScientificMockProvider {
    name = 'Demo Mode (Mock)';
    async listModels() {
    ...
    async simulateScientificResponse(request) {
        ...
        const hasFigure = request.messages.some((m) => m.role === 'tool' && m.name === 'figure_generator');
        if (!hasFigure) {
            return {
...
//# sourceMappingURL=ScientificMockProvider.js.map